class InfoMessage:
    ...
    def __init__(self,
        ...
        # количество килокалорий, которое израсходовал
...
class Training:
    ...
    def __init__(self,
                 action: int,
                 # количество совершённых действий (число шагов при ходьбе
...
class Running(Training):
    ...
    """Переопределенная функция с формулой для расчёта калорий"""
